public class Manager extends Employee
{
	...
	//Constructor
	public Manager(String id,String name,double salary,double bonus) //There should be 4 parameters now: String aId, String aName, double aSalary, double aBonus
	{
		super(id,name,salary); //call the constructor of the superclass, Employee: super(aId, aName, aSalary); 
		this.bonus = bonus; //Set the bonus field: aBonus
	}
