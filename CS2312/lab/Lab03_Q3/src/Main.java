...
public class Main {
	...
	private static Team[] createTeams(Student[] students) 
	{
			...
			int incrementBy6 =0;
			//Create the 5 teams
			result[0]=new Team("Team A",Arrays.copyOfRange(students, incrementBy6,incrementBy6+=6)); //give team name and array of 6 students: "Team A", Arrays.copyOfRange(students, 0,6)
			result[1]=new Team("Team B",Arrays.copyOfRange(students, incrementBy6,incrementBy6+=6)); //Create the second team : new Team("Team B", Arrays.copyOfRange(students, 6,12));
